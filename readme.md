# S3plus
Pretty standard stuff these days. I stripped a lot out of this because there were just better ways todo it now.

## About
The cloudformation template is designed to create a secure S3 bucket preconfigured for website hosting.
